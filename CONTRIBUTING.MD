...
Write your code, fix the bug, or add the feature. When you are ready, save your changes with a clear commit message:
git add .
git commit -m "A short, descriptive message explaining what you changed"

### 5. Push to Your Fork
Push your new branch up to your GitHub fork:
git push origin feature/your-feature-name

### 6. Open a Pull Request (PR)
1. Go to the original repository on GitHub.
2. You should see a green button that says "Compare & pull request". Click it.
3. Describe your changes in the PR description (what you did and why).
